...
@JsonSubTypes({
    @JsonSubTypes.Type(value = com.ufund.api.ufundapi.model.UserExperiement.Helper.class, name = "helper"),
    @JsonSubTypes.Type(value = com.ufund.api.ufundapi.model.UserExperiement.Admin.class, name = "admin")
})
public abstract class UserExperiement {
     ...
     */
    public UserExperiement(@JsonProperty("username") String username){
    ...
    @JsonTypeName("helper")
    public static class Helper extends UserExperiement{
    ...
    @JsonTypeName("admin")
    public static class Admin extends UserExperiement{
